...
namespace ProtoMsg {
    ...
    static BattlePBReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::ProtoMsg.BattleUserInputC2S), global::ProtoMsg.BattleUserInputC2S.Parser, new[]{ "RolesID", "RoomID", "Key", "MousePosition", "LockTag", "LockID" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::ProtoMsg.BattleUserInputS2C), global::ProtoMsg.BattleUserInputS2C.Parser, new[]{ "CMD" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public void MergeFrom(BattleUserInputC2S other) {
      ...
      if (other.mousePosition_ != null) {
        if (mousePosition_ == null) {
          MousePosition = new global::ProtoMsg.V3Info();
        }
  ...
  #endif
  {
    ...
    public void MergeFrom(BattleUserInputS2C other) {
      ...
      if (other.cMD_ != null) {
        if (cMD_ == null) {
          CMD = new global::ProtoMsg.BattleUserInputC2S();
        }
